...
<body>
	<div class="container">
		<!-- Header -->
		<div class="header">
			<img src="https://yabangee.com/wp-content/uploads/sabancı-university-2.jpg" alt="Sabancı University Logo">
	...
	<script>
        function redirectToCategoryPage() {
            ...
            const categoryId = 'A1'; // Replace with the actual category ID for this page
