...
<div class="container">
    ...
    <!-- Preview Section: Accordion-like collapsible category previews -->
    <div class="prelook-container">
        ...
        <?php else: ?>
            <?php foreach ($winnersByCategory as $catCode => $winnerRows): ?>
                ...
                ?>
                <!-- Category Row: Clickable to toggle winners list -->
                ...
                <!-- Collapsible Winners List for this Category -->
...
$(document).ready(function() {
    // Toggle winners list on category row click
    ...
    $('.remove-candidate').on('click', function(e) {
        // Prevent toggle of parent row when clicking remove
        e.stopPropagation();
        ...
        $.ajax({
            url: 'api/removeWinnerCandidate.php',
            type: 'POST',
